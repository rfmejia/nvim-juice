...
vim.api.nvim_create_autocmd("FileType", autocmd_ft_opts({"sql", "mysql", "pgsql"}, vim.env.DADBOD_MYSQL_DB))
return vim.api.nvim_create_autocmd("FileType", autocmd_ft_opts("redis", vim.env.DADBOD_REDIS_DB))
