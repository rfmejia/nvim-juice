...
local function set_hl(hi_options)
  if (nil == hi_options) then
    _G.error("Missing argument hi-options on /home/rfmejia/.config/nvim/fnl/colors/default-black.fnl:35", 2)
  else
  end
