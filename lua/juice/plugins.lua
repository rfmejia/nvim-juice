...
dev_tools = {{"neovim/nvim-lspconfig", ft = {"clojure", "java", "go", "scala", "javascript", "typescript"}, config = _8_}, {"scalameta/nvim-metals", cmd = "MetalsInit", dependencies = {"nvim-lua/plenary.nvim"}}}
local lisp_tools
do
