...
core = {{"Olical/nfnl", ft = "fennel"}, {"projekt0n/github-nvim-theme", priority = 1000, config = _5_, lazy = false}, {"nvim-treesitter/nvim-treesitter", event = {"BufReadPre", "BufNewFile"}, build = ":TSUpdate", config = _6_}}
local ui_tools
local function _7_()
...
ui_tools = {{"stevearc/oil.nvim", cmd = "Oil", config = {default_file_explorer = true, delete_to_trash = true}}, {"nvim-telescope/telescope.nvim", tag = "0.1.6", dependencies = {"nvim-lua/plenary.nvim"}, config = _7_}, {"lewis6991/gitsigns.nvim", event = {"BufReadPre", "BufNewFile"}, config = true}, {"mbbill/undotree", cmd = "UndotreeToggle", config = _8_}}
...
local function _10_()
  ...
  return vim.api.nvim_create_autocmd("FileType", {pattern = {"sql", "mysql"}, callback = _11_})
end
...
local function setup()
  ...
  local plugins = concat(core, ui_tools, text_tools, dev_tools, database_tools, vim_fu)
