...
local function setup()
  ...
  nmap({tn = {":tabnew<cr>", {"noremap"}}, tc = {":tabclose<cr>", {"noremap"}}, ts = {":tab split<cr>", {"noremap"}}, ["[t"] = {":tabprevious<cr>", {"noremap"}}, ["]t"] = {":tabnext<cr>", {"noremap"}}, ["[T"] = {":tabfirst<cr>", {"noremap"}}, ["]T"] = {":tablast<cr>", {"noremap"}}})
