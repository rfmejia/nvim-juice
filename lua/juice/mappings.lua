...
local general = {{"n", "Y", "y$", {desc = "yank until the end of the line"}}, {"n", "<C-l>", ":nohl<cr>", {desc = "clear search highlight"}}, {"n", "<leader>;", ":<C-r>\"", {desc = "paste register 0 contents in command mode"}}, {"n", "<leader>w", ":w<cr>", {desc = "write buffer"}}, {"n", "<leader>n", ":registers<cr>", {desc = "list registers"}}, {"n", "<F5>", ":make<cr>", {desc = "trigger `make` in shell"}}, {"n", "<F2>", "let @+ = getreg('%')", {desc = "copy current file path to clipboard"}}, {"n", "g?", ":vert h<cr>", {desc = "open help", silent = true}}}
