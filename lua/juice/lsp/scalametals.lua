...
local function initialize_metals()
  ...
  config.settings = {showImplicitArguments = true, showImplicitConversionsAndClasses = true, showInferredType = true, decorationColor = "Conceal", scalafixRulesDependencies = {"com.nequissimus::sort-imports:0.6.1"}}
