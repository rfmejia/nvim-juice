...
local function configure_completion(client, bufnr)
  if (nil == bufnr) then
    _G.error("Missing argument bufnr on /home/rfmejia/.config/nvim/fnl/juice/lsp.fnl:60", 2)
  else
  end
  if (nil == client) then
    _G.error("Missing argument client on /home/rfmejia/.config/nvim/fnl/juice/lsp.fnl:60", 2)
  else
  end
