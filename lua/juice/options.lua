...
--[[ "---- COMPLETION ----" ]]
local completion = {complete = {".", "w", "b", "u", "t", "kspell"}, completeopt = {"menuone", "popup", "fuzzy", "noselect", "preview"}, path = {".", "", "**"}, wildmode = {"lastused", "full"}, wildignorecase = true, wildoptions = {"fuzzy", "pum"}, pumborder = "rounded"}
