-- [nfnl] Compiled from fnl/juice/options.fnl by https://github.com/Olical/nfnl, do not edit.
...
--[[ "---- FILETYPES ----" ]]
local filetypes = {extension = {edn = "clojure", mill = "scala", sbt = "scala", sc = "scala", txt = "text"}, filename = {Jenkinsfile = "groovy", ["tmux.conf"] = "tmux"}}
--[[ "---- AUTOCMDS ----" ]]
