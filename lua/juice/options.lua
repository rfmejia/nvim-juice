...
--[[ "---- COMPLETION ----" ]]
local completion = {complete = {".", "w", "b", "u", "t", "kspell"}, completeopt = {"menuone", "popup", "fuzzy", "noselect", "preview"}, path = {".", "", "**"}, wildmode = {"lastused", "full"}, wildignorecase = true, wildoptions = {"fuzzy", "pum"}}
...
--[[ "---- FILETYPES ----" ]]
local filetypes = {extension = {avsc = "json", edn = "clojure", mill = "scala", mysql = "sql", pgsql = "sql", sbt = "scala", sc = "scala", tofu = "hcl", txt = "text"}, filename = {[".envrc"] = "bash", Jenkinsfile = "groovy", ["tmux.conf"] = "tmux"}, pattern = {["openapi.*%.yaml"] = "yaml.openapi", ["openapi.*%.json"] = "json.openapi"}}
--[[ "---- AUTOCMDS ----" ]]
