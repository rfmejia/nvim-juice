...
--[[ "---- COMPLETION ----" ]]
local completion = {complete = {".", "w", "b", "u", "t", "kspell"}, completeopt = {"menu", "popup", "fuzzy", "noselect", "preview"}, path = {".", "", "**"}, wildmode = {"lastused", "full"}, wildignorecase = true, wildoptions = {"fuzzy", "pum"}}
