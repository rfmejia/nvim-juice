...
local cterm_opts = {Comment = {ctermfg = "DarkGray", italic = true}, Constant = {ctermfg = "Green"}, CursorLineNr = {ctermfg = "White"}, [{"Delimiter", "Operator", "Special", "Statement"}] = {ctermfg = "Gray"}, [{"LineNrAbove", "LineNrBelow"}] = {ctermfg = "DarkGray"}, [{"NonText", "WinSeparator"}] = {ctermfg = "Black"}, Todo = {ctermfg = "Yellow", bold = true}}
...
local function set_hl(hi_options)
  _G.assert((nil ~= hi_options), "Missing argument hi-options on /home/rfmejia/.config/nvim/fnl/juice/colorscheme.fnl:28")
