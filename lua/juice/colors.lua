...
local function get_gnome_colorscheme(dark_scheme, light_scheme)
  _G.assert((nil ~= light_scheme), "Missing argument light-scheme on /home/rfmejia/.config/nvim/fnl/juice/colors.fnl:50")
  _G.assert((nil ~= dark_scheme), "Missing argument dark-scheme on /home/rfmejia/.config/nvim/fnl/juice/colors.fnl:50")
