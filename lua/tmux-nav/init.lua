...
local function vim_direction(direction)
  if (nil == direction) then
    _G.error("Missing argument direction on /home/rfmejia/.config/nvim/fnl/tmux-nav/init.fnl:7", 2)
  else
  end
...
local function tmux_direction(direction)
  if (nil == direction) then
    _G.error("Missing argument direction on /home/rfmejia/.config/nvim/fnl/tmux-nav/init.fnl:8", 2)
  else
  end
...
local function vim_navigate(direction)
  if (nil == direction) then
    _G.error("Missing argument direction on /home/rfmejia/.config/nvim/fnl/tmux-nav/init.fnl:10", 2)
  else
  end
...
local function tmux_navigate(direction)
  if (nil == direction) then
    _G.error("Missing argument direction on /home/rfmejia/.config/nvim/fnl/tmux-nav/init.fnl:19", 2)
  else
  end
...
local function navigate(direction)
  if (nil == direction) then
    _G.error("Missing argument direction on /home/rfmejia/.config/nvim/fnl/tmux-nav/init.fnl:27", 2)
  else
  end
...
local function setup_default_mapping(in_tmux_3f)
  ...
  local function _26_(dir)
    if (nil == dir) then
      _G.error("Missing argument dir on /home/rfmejia/.config/nvim/fnl/tmux-nav/init.fnl:54", 2)
    else
    end
    local mapping
