...
local function vim_direction(direction)
  _G.assert((nil ~= direction), "Missing argument direction on /home/rfmejia/.config/nvim/fnl/tmux-nav/init.fnl:7")
...
local function tmux_direction(direction)
  _G.assert((nil ~= direction), "Missing argument direction on /home/rfmejia/.config/nvim/fnl/tmux-nav/init.fnl:8")
...
local function vim_navigate(direction)
  _G.assert((nil ~= direction), "Missing argument direction on /home/rfmejia/.config/nvim/fnl/tmux-nav/init.fnl:10")
...
local function tmux_navigate(direction)
  _G.assert((nil ~= direction), "Missing argument direction on /home/rfmejia/.config/nvim/fnl/tmux-nav/init.fnl:19")
...
local function navigate(direction)
  _G.assert((nil ~= direction), "Missing argument direction on /home/rfmejia/.config/nvim/fnl/tmux-nav/init.fnl:27")
